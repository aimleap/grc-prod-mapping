...
def getCleannationalBrand(nationalBrand):
    ...
    nationalBrandgrupd = nationalBrandgrupd1[['NewTitle','product_title','url','stdUPC','brandStatus','weight']]
...
def getCleanstoreBrand(storeBrand):
    ...
    storeBrandgrupd = storeBrandgrupd1[['NewTitle','product_title','url','stdUPC','brandStatus','weight']]
...
def main():
    ...
    storeBrandgrupd = storeBrandgrupd[['Sl.No','product_title', 'brandStatus', 'jewel_url', 'marianos_url',
           'target_url', 'walmart_url', 'UPC','weight']]
